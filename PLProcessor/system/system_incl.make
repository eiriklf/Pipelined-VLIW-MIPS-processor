...
# Project:C:\Users\torbjlan\dmkonsttdt4255_work\PLProcessor\system\system.xmp
#
...
RWPLPROCESSOR_OUTPUT_DIR = rwPLProcessor
RWPLPROCESSOR_OUTPUT = $(RWPLPROCESSOR_OUTPUT_DIR)/executable.elf
CYG_RWPLPROCESSOR_OUTPUT_DIR = rwPLProcessor
CYG_RWPLPROCESSOR_OUTPUT = $(CYG_RWPLPROCESSOR_OUTPUT_DIR)/executable.elf
...
BRAMINIT_ELF_FILES =  $(CYG_RWPLPROCESSOR_OUTPUT) 
BRAMINIT_ELF_FILE_ARGS =   -pe microblaze_0 $(RWPLPROCESSOR_OUTPUT) 

ALL_USER_ELF_FILES = $(CYG_TESTAPP_MEMORY_MICROBLAZE_0_OUTPUT) $(CYG_TESTAPP_PERIPHERAL_MICROBLAZE_0_OUTPUT) $(CYG_RWPLPROCESSOR_OUTPUT) 
...
SIMGEN_OPTIONS = -p $(DEVICE) -lang $(LANGUAGE) $(SEARCHPATHOPT) $(BRAMINIT_ELF_FILE_ARGS) $(MIX_LANG_SIM_OPT) -msg __xps/ise/xmsgprops.lst -s mti -X C:/Users/torbjlan/dmkonsttdt4255_work/PLProcessor/system/
...
PROGRAMCLEAN_TARGETS = TestApp_Memory_microblaze_0_programclean TestApp_Peripheral_microblaze_0_programclean rwPLProcessor_programclean 
...
implementation/plprocessor_0_wrapper.ngc
...
#################################################################
# SOFTWARE APPLICATION RWPLPROCESSOR
#################################################################

RWPLPROCESSOR_SOURCES = drivers/plprocessor_v1_00_a/src/rwMain.c 

RWPLPROCESSOR_HEADERS = drivers/plprocessor_v1_00_a/src/plprocessor.h 

RWPLPROCESSOR_CC = mb-gcc
RWPLPROCESSOR_CC_SIZE = mb-size
RWPLPROCESSOR_CC_OPT = -O2
RWPLPROCESSOR_CFLAGS = 
RWPLPROCESSOR_CC_SEARCH = # -B
RWPLPROCESSOR_LIBPATH = -L./microblaze_0/lib/ # -L
RWPLPROCESSOR_INCLUDES = -I./microblaze_0/include/  -Idrivers/plprocessor_v1_00_a/src/ # -I
RWPLPROCESSOR_LFLAGS = # -l
RWPLPROCESSOR_LINKER_SCRIPT = rwPLProcessor/rwPLProcessor_linker_script.ld
RWPLPROCESSOR_LINKER_SCRIPT_FLAG = -T $(RWPLPROCESSOR_LINKER_SCRIPT) 
RWPLPROCESSOR_CC_DEBUG_FLAG =  -g 
RWPLPROCESSOR_CC_PROFILE_FLAG = # -pg
RWPLPROCESSOR_CC_GLOBPTR_FLAG= # -mxl-gp-opt
RWPLPROCESSOR_MODE = executable
RWPLPROCESSOR_LIBG_OPT = -$(RWPLPROCESSOR_MODE) microblaze_0
RWPLPROCESSOR_CC_INFERRED_FLAGS= -mno-xl-soft-mul -mxl-barrel-shift -mxl-pattern-compare -mcpu=v8.00.b 
RWPLPROCESSOR_CC_START_ADDR_FLAG=  #  # -Wl,-defsym -Wl,_TEXT_START_ADDR=
RWPLPROCESSOR_CC_STACK_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_STACK_SIZE=
RWPLPROCESSOR_CC_HEAP_SIZE_FLAG=  #  # -Wl,-defsym -Wl,_HEAP_SIZE=
RWPLPROCESSOR_OTHER_CC_FLAGS= $(RWPLPROCESSOR_CC_GLOBPTR_FLAG)  \
                  $(RWPLPROCESSOR_CC_START_ADDR_FLAG) $(RWPLPROCESSOR_CC_STACK_SIZE_FLAG) $(RWPLPROCESSOR_CC_HEAP_SIZE_FLAG)  \
                  $(RWPLPROCESSOR_CC_INFERRED_FLAGS)  \
                  $(RWPLPROCESSOR_LINKER_SCRIPT_FLAG) $(RWPLPROCESSOR_CC_DEBUG_FLAG) $(RWPLPROCESSOR_CC_PROFILE_FLAG) 
