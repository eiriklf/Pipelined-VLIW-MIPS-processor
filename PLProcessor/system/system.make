...
# C:\Users\torbjlan\dmkonsttdt4255_work\PLProcessor\system\system.mhs
# The software specification of the system is in file :
# C:\Users\torbjlan\dmkonsttdt4255_work\PLProcessor\system\system.mss
...
rwPLProcessor_program: $(CYG_RWPLPROCESSOR_OUTPUT) 

$(CYG_RWPLPROCESSOR_OUTPUT) : $(RWPLPROCESSOR_SOURCES) $(RWPLPROCESSOR_HEADERS) $(RWPLPROCESSOR_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/rwplprocessor_compiler.opt
	@mkdir -p $(RWPLPROCESSOR_OUTPUT_DIR) 
	$(RWPLPROCESSOR_CC) $(RWPLPROCESSOR_CC_OPT) $(RWPLPROCESSOR_SOURCES) -o $(CYG_RWPLPROCESSOR_OUTPUT) \
	$(RWPLPROCESSOR_OTHER_CC_FLAGS) $(RWPLPROCESSOR_INCLUDES) $(RWPLPROCESSOR_LIBPATH) \
	$(RWPLPROCESSOR_CFLAGS) $(RWPLPROCESSOR_LFLAGS) 
	$(RWPLPROCESSOR_CC_SIZE) $(CYG_RWPLPROCESSOR_OUTPUT) 
	@echo ""

rwPLProcessor_programclean:
	rm -f $(RWPLPROCESSOR_OUTPUT) 
