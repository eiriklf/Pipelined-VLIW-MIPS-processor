/*****************************************************************************
* Filename:          C:\Users\torbjlan\dmkonsttdt4255_work\PLProcessor\system/drivers/plprocessor_v1_00_a/src/plprocessor_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the plprocessor driver
...
XStatus PLPROCESSOR_SelfTest(void * baseaddr_p)
{
  ...
  PLPROCESSOR_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = PLPROCESSOR_mReadSlaveReg0(baseaddr, 0);
  ...
  PLPROCESSOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = PLPROCESSOR_mReadSlaveReg1(baseaddr, 0);
  ...
  PLPROCESSOR_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = PLPROCESSOR_mReadSlaveReg2(baseaddr, 0);
  ...
  PLPROCESSOR_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = PLPROCESSOR_mReadSlaveReg3(baseaddr, 0);
  ...
  PLPROCESSOR_mWriteSlaveReg4(baseaddr, 0, 5);
  Reg32Value = PLPROCESSOR_mReadSlaveReg4(baseaddr, 0);
